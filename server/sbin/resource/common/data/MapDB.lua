...
mapDB =
{
	...
	[500] = { 
			...
			level 		= 0,
			mapType 	= MapType.City,
			npcs 		= {31481,31485,31484,31482,31483, },
			safeX 		= 0,
			safeY 		= 0,
		},
	...
	[602] = { 
			...
			level 		= 0,
			mapType 	= MapType.Copy,
			npcs 		= {30147,30125,30104,30140,30141,30106,30142,30139,30137,30136,30133,30135,30123,30145,30146,30097,30119,30098,30134,30129,30114,30115,30096, },
			safeX 		= 0,
			safeY 		= 0,
		},
