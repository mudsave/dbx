...
mapDB =
{
	...
	[10] = { 
			...
			level 		= 0,
			mapType 	= MapType.City,
			npcs 		= {20059,30320,20049,29081,60500,29008,29048,29006,29083,50050,39050,30252,60000,27150,29079,20928,29065,20012,20013,20014,29082,20015,20016,29001,29002,29003,20106,20107,20108,29004,20017,39000,29056,29005,29007, },
			safeX 		= 189,
			safeY 		= 208,
	...
	[99] = { 
			...
			level 		= 0,
			mapType 	= MapType.City,
			npcs 		= {40011,40012,30250,40013,40014,30251,40015,29092,40016, },
			safeX 		= 0,
			safeY 		= 0,
		},
