...
DailyTaskDB = 
{
	...
	[40001] = 
	{
		...
		content = "<font color ='#FFFFFFFF'>通过</font><font color = '#FFFFFF00'>任务、日常活动、野外自动遇怪</font><font color ='#FFFFFFFF'>，击杀等级相近的妖物</font><font color = '#FFFFFF00'>200</font><font color ='#FFFFFFFF'>只。</font><font color = '#FFFFFF00'>（当前已消灭妖物%d只）</font><font color = '#F89CFF0'>（目标：累计消灭%d只妖物）</font>",		-- 任务日志中显示的，任务内容
		...
		{
			[1] = {type= "TkillMonster",param = {monsterID	= {-5,5},targetCount = 200,currentCount = 0 },tip = "累计消灭200只与你等级相近的作乱妖物"},
		},
		triggers = --任务触发器
		{
			
		},
		quitDesc = "<font color ='#FFFFFFFF'>放弃当前任务，</font><font color = '#FFFF0000'>任务进度将清零，</font><font color ='#FFFFFFFF'>同时</font><font color = '#FFFF0000'>今天将无法再接取</font><font color ='#FFFFFFFF'>，你确定吗？</font>",
	},
	[40002] = 
	{
		name = "帮会休闲挑战",			-- 任务名称
