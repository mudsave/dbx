...
-----------31-32主线任务-----------
	[1151] ={                  --[[查探孙坚下落--]]
		...
		startDialogID = 1101,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
							[1] = {npcID = 20601, mapID = 110, x = 142, y = 191, dir = North,}, --吴明
						},
					},
			},
	...
	[1152] =
	{
		...
		startDialogID = 1105,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
							[1] = {npcID = 20602, mapID = 110, x = 201, y = 109, dir = WestSouth,}, --创建杨定
							[2] = {npcID = 20625, mapID = 110, x = 200, y = 107, dir = EastNorth,}, --创建孙坚
							[3] = {npcID = 20604, mapID = 110, x = 198, y = 108, dir = EastSouth,}, --创建潼关隘口守卫1
							[4] = {npcID = 20629, mapID = 110, x = 199, y = 105, dir = East,}, --创建潼关隘口守卫2
							[5] = {npcID = 20630, mapID = 110, x = 202, y = 105, dir = North,}, --创建潼关隘口守卫3
							[6] = {npcID = 20631, mapID = 110, x = 202, y = 108, dir = West,}, --创建潼关隘口守卫4
		...
		[1] = {type='Tarea',param = {mapID = 110 , x = 200, y = 111, bor = true},},-------到达指定坐标
			...
			triggers = --任务触发器
			{
				...
				param={
						npcs =
						{
						[1] = {npcID = 20606, mapID = 110, x = 200, y = 107, dir = EastNorth,}, --创建祖茂
						},
					},
				},
				},
	...
	[1154] =
	{
		...
		startDialogID = 1111,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
						[1] = {npcID = 20605, mapID = 110, x = 168, y = 98, dir = EastSouth,}, --徐荣
						[2] = {npcID = 20641, mapID = 110, x = 166, y = 101, dir = EastSouth,}, --孙坚
						[3] = {npcID = 20632, mapID = 110, x = 164, y = 99, dir = East,}, --小怪1
						[4] = {npcID = 20633, mapID = 110, x = 162, y = 102, dir = EastSouth,}, --小怪2
						[5] = {npcID = 20634, mapID = 110, x = 165, y = 105, dir = WestSouth,}, --小怪3
						[6] = {npcID = 20635, mapID = 110, x = 169, y = 101, dir = WestNorth,}, --小怪4
						},
					},
			},
			},
	...
	[1155] =
	{
		...
		startDialogID = 1115,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
							[1] = {npcID = 20607, mapID = 110, x = 132, y = 121, dir = EastSouth,}, --朱治
							[2] = {npcID = 20608, mapID = 110, x = 130, y = 121, dir = EastSouth,}, --吴景
						},
					},
			},
			},
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
							[1] = {npcID = 20646, mapID = 110, x = 169, y = 94, dir = EastSouth,}, --创建孙坚
						},
					},
			},
	...
	[1157] =
	{
		...
		nextTaskID = 1157,	--任务后置任务没有填nil
		startDialogID = 1121,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
							[1] = {npcID = 20610, mapID = 110, x = 97, y = 123, dir = EastSouth,}, --伍习
						},
					},
			},
	...
	[1158] =
	{
		...
		startDialogID = 1125,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
							[1] = {npcID = 20613, mapID = 110, x = 26, y = 166, dir = South,}, --梁兴
							[2] = {npcID = 20626, mapID = 110, x = 24, y = 164, dir = EastSouth,}, --黄盖
							[3] = {npcID = 20614, mapID = 110, x = 24, y = 162, dir = EastNorth,}, --黄盖看守
							[4] = {npcID = 20638, mapID = 110, x = 23, y = 168, dir = WestSouth,}, --黄盖看守
						},
					},
			},
			},
	...
	[1159] =
	{
		...
		startDialogID = 1131,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
							[1] = {npcID = 20615, mapID = 110, x = 201, y = 110, dir = WestSouth,}, --张济
						},
					},
			},
	...
	[1160] =
	{
		...
		startDialogID = 1137,	--接任务对话ID没有填nil
		endDialogID = 1140,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
		...
		triggers = --任务触发器
		{
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
							[1] = {npcID = 20617, mapID = 110, x = 207, y = 60, dir = North,}, --张横
							[2] = {npcID = 20618, mapID = 110, x = 205, y = 58, dir = North,}, --妖阵守将1
							[3] = {npcID = 20637, mapID = 110, x = 209, y = 58, dir = North,}, --妖阵守将2
						},
					},
			},
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
							[1] = {npcID = 20640, mapID = 110, x = 207, y = 60, dir = EastSouth,}, --创建张横
						},
					},
			},
	...
	[1161] =
	{
		...
		startDialogID = 1141,	--接任务对话ID没有填nil
		endDialogID = 1145,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
		...
		triggers = --任务触发器
		{
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
							[1] = {npcID = 20619, mapID = 111, x = 34, y = 32, dir = West,}, --创建吕岳（幻像）
						},
					},
			},
			},
			...
			{type="createPrivateNpc",
				param={
						npcs =
						{
							[1] = {npcID = 20639, mapID = 111, x = 34, y = 32, dir = West,}, --创建吕岳（幻像）
						},
					},
			},
	...
	[1162] =
	{
		...
		startDialogID = 1146,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			...
			{type="finishTask", param = {recetiveTaskID = 1163}},
			},
		},
	},
	[1163] =
	{
		...
		startDialogID = 1149,	--接任务对话ID没有填nil
		endDialogID = 1151,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
   ...
   [1164] =
	{
		...
		startDialogID = 1152,	--接任务对话ID没有填nil
		endDialogID = 1155,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
   ...
   [1165] =
	{
		...
		startDialogID = 1157,	--接任务对话ID没有填nil
		endDialogID = 1159,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
	   ...
	   [1166] =
	{
		...
		startDialogID = 1159,	--接任务对话ID没有填nil
		endDialogID = 1162,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
	...
	[1167] =
	{
		...
		startDialogID = 1162,	--接任务对话ID没有填nil
		endDialogID = 1165,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
		...
		triggers = --任务触发器
			{
				...
				param={
						npcs =
						{
							[1] = {npcID = 20624, mapID = 111, x = 34, y = 32, dir = WestNorth,}, --吕岳
						},
					},
				},
				{type="deletePrivateNpc",
		...
		[1] = {type='Tarea',param = {mapID = 110 , x = 169, y = 94, bor = false},},-------到达指定坐标
			...
			triggers = --任务触发器
			{
				...
				param={
						npcs =
						{
							[1] = {npcID = 20627, mapID = 110, x = 169, y = 94, dir = EastSouth,}, --创建黄盖
						},
					},
				},
		...
		triggers = --任务触发器
			{
				...
				param={
						npcs =
						{
							[1] = {npcID = 20605, mapID = 110, x = 56, y = 198, dir = WestSouth,}, --徐荣
							[2] = {npcID = 20642, mapID = 110, x = 59, y = 197, dir = WestSouth,}, --妖阵精兵1
							[3] = {npcID = 20643, mapID = 110, x = 53, y = 197, dir = WestSouth,}, --妖阵精兵2
							[4] = {npcID = 20644, mapID = 110, x = 57, y = 200, dir = WestSouth,}, --妖阵守将1
							[5] = {npcID = 20645, mapID = 110, x = 54, y = 200, dir = WestSouth,}, --妖阵守将2
						},
					},
			},
				},
	...
	[1173] =
	{
		...
		startDialogID = 1183,	--接任务对话ID没有填nil
		endDialogID = 1186,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
		...
		[TaskStatus.Done]		=
			...
			{type="finishTask", param = {recetiveTaskID =1174}},
			},
		},
		},
	[1174] =
	{
		...
		startDialogID = 1185,	--接任务对话ID没有填nil
...
[1200] =
	{
		...
		nextTaskID = 1200,	--任务后置任务没有填nil
		startDialogID =	1201,	--接任务对话ID没有填nil
...
[1201] =
		...
		startDialogID = 1202,	--接任务对话ID没有填nil
...
[1202] =
		...
		startDialogID = 1205,	--接任务对话ID没有填nil
...
[1203] =
	{
		...
		startDialogID =	1208,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			...
			[TaskStatus.Active] =
				...
				param={ 
						npcs =
						{
							[1] = {npcID = 20702, mapID = 106, x = 218, y = 119, dir = EastSouth,}, --貂蝉
							[2] = {npcID = 20703, mapID = 106, x = 216, y = 118, dir = EastSouth,}, --萵姬
						},
					},
				},
				},
...
[1204] =
		...
		startDialogID = 1211,	--接任务对话ID没有填nil
		endDialogID =1213,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
...
[1205] =
		...
		startDialogID = 1214,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			[TaskStatus.Active] =
				...
				param={
						npcs =
						{
							[1] = {npcID = 20707, mapID = 106, x = 161, y = 87, dir = WestSouth,}, --魔化吕布
						},
					},
			},
			{type="deletePrivateNpc",
			...
			{type="createPrivateNpc",  --私有npc创建
				param={
						npcs =
						{
							[1] = {npcID = 20702, mapID = 106, x = 161, y = 86, dir = WestSouth,}, --貂蝉
						},
					},
			},
                        {type="deletePrivateNpc",
...
[1206] =
	{
		...
		startDialogID =	1217,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			...
			{type="createPrivateNpc",  --私有npc创建
				param={
						npcs =
						{
							[1] = {npcID = 20752, mapID = 13, x = 132, y = 119, dir = EastSouth,}, --郭汜
						},
					},
			},
		        {type="openDialog", param={dialogID = 1238},},
			{type="finishTask", param = {recetiveTaskID = 1208}},
			},
		},
	},
...
[1208] =
		...
		name = "质问曹性",	--任务名字
		startNpcID = 20708,	--任务起始npc
		endNpcID = 20710,		--任务结束npc
		preTaskData = {1207},	--任务前置任务没有填nil
		nextTaskID = 1209,	--任务后置任务没有填nil
		startDialogID = 1238,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			[TaskStatus.Active] =
				...
				param={
						npcs =
						{
							[1] = {npcID = 20710, mapID = 13, x = 85, y = 65, dir = EastSouth,}, --曹性
							[2] = {npcID = 20721, mapID = 13, x = 83, y = 68, dir = EastSouth,}, --曹营守将
							[3] = {npcID = 20753, mapID = 13, x = 83, y = 63, dir = EastSouth,}, --曹营小兵
							[4] = {npcID = 20722, mapID = 13, x = 80, y = 64, dir = EastSouth,}, --曹营守将
							[5] = {npcID = 20754, mapID = 13, x = 80, y = 68, dir = EastSouth,}, --曹营小兵
						},
					},
			},
			},
			...
			{type="createPrivateNpc",  --私有npc创建
				param={
						npcs =
						{
							[1] = {npcID = 20731, mapID = 13, x = 85, y = 65, dir = EastSouth,}, --曹性
						},
					},
			},
			
		        {type="openDialog", param={dialogID = 1241},},
			{type="finishTask", param = {recetiveTaskID = 1209}},
			},
		},
	},
...
[1209] =
		...
		startDialogID = 1241,	--接任务对话ID没有填nil
		...
		triggers = --任务触发器
		{
			...
			{type="createPrivateNpc",  --私有npc创建
				param={
						npcs =
						{
							[1] = {npcID = 20730, mapID = 13, x = 98, y = 135, dir = EstSouth,}, --孙胜
						},
					},
			},
		...
		triggers = --任务触发器
			{
				...
				param={
						npcs =
						{
							[1] = {npcID = 20714, mapID = 115, x = 72, y = 193, dir = EastSouth,}, --天山小妖
						        [2] = {npcID = 20712, mapID = 115, x = 66, y = 188, dir = EastSouth,}, --天山妖魔
						},
					},
		           	},
				},
...
[1218] =
		...
		startDialogID = 1263,	--接任务对话ID没有填nil
		endDialogID =1264,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
		...
		triggers = --任务触发器
		{
			...
			{type="deletePrivateNpc",
		        ...
		        {type="openDialog", param={dialogID = 1263},},
			{type="finishTask", param = {recetiveTaskID = 1219}},
			},
		},
	},
		...
		[1] = {type='Tmine',param =     --雪莲守妖
			...
			triggers = --任务触发器
			{
				...
				param={
						npcs =
						{
							[1] = {npcID = 20764, mapID = 115, x = 118, y = 148, dir = EastSouth,}, --雪莲守妖
						},
					},
		           	},
					{type="openDialog", param={dialogID = 1267},},	
					{type="finishTask", param = {recetiveTaskID = 1220}}	
			},
	},
	},
[1220] = 
		...
		[1] = {type='Tmine',param =     --俄何烧戈
			...
			triggers = --任务触发器
			{
				...
				param={
						npcs =
						{
							[1] = {npcID = 20733, mapID = 115, x = 207, y = 80, dir = EastNorth,}, --俄何烧戈
						},
					},
		           	},
					{type="openDialog", param={dialogID = 1270},},	
					{type="finishTask", param = {recetiveTaskID = 1221}}	
			},
	},
	},
		...
		[2] = {type='Tmine',param =     --雷兽
			...
			triggers = --任务触发器
			{
				...
				param={
						npcs =
						{
							[1] = {npcID = 20734, mapID = 115, x = 75, y =108, dir = South,}, --雷兽
						},
					},
		           	},
				{type="deletePrivateNpc",
...
[1223] =
		...
		startDialogID = 1279,	--接任务对话ID没有填nil
		endDialogID =1280,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
		...
		triggers = --任务触发器
		{
			...
			{type="finishTask", param = {recetiveTaskID = 1224}},
			},
		},
	},
[1224] =
		...
		startDialogID = 1281,	--接任务对话ID没有填nil
		endDialogID =1282,	--交任务对话ID没有填nil
		taskType2 = TaskType2.Main,--任务类型
		school = nil,	--门派限制没有填nil
		level = {1,150},--等级限制
		rewards = --任务奖励没有填{}
		...
		triggers = --任务触发器
		{
			[TaskStatus.Active] =
				...
				param={
						npcs =
						{
							[1] = {npcID = 20702, mapID = 116, x = 173, y = 160, dir = EastSouth,}, --貂蝉
						},
					},
			         },
			},
	...
	{                      --[[降服魔化吕布--]]     
		...
		triggers = --任务触发器
		{
			[TaskStatus.Active] =
				...
				param={
				npcs ={
				   [1] = {npcID = 20707, mapID = 116, x = 154, y = 149, dir = EastSouth,}, --魔化吕布
					},
					},
			        },
			},
			...
			{type="createPrivateNpc",  --私有npc创建
				param={
				npcs ={
				   [1] = {npcID = 20719, mapID = 116, x = 154, y = 149, dir = EastSouth,}, --吕布
				   [2] = {npcID = 20702, mapID = 116, x = 155, y = 146, dir = EastSouth,}, --貂蝉
					},
				},
		     },
