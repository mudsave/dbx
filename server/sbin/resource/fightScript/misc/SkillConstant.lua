...
PetSkillEffect2AttrName = {
	...
	[PetPassiveEffect.CritDmgRatio]		= { nil,pet_inc_critical_effect },
	
	[PetPassiveEffect.HitProb]			= { pet_add_hit,nil },
	[PetPassiveEffect.Dodge]			= { pet_add_dodge,nil },
	[PetPassiveEffect.AntiCrit]			= { pet_add_tenacity,nil },
