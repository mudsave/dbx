...
mapDB =
{
	...
	[2] = { 
			...
			level 		= nil,
			mapType 	= MapType.City,
			npcs 		= {29069,29045,20022,29075,29053,20007,29062, },
			safeX 		= 87,
			safeY 		= 13,
		},
	...
	[3] = { 
			...
			level 		= nil,
			mapType 	= MapType.City,
			npcs 		= {20006,20023,29061,29074,29041,29068,29052, },
			safeX 		= 96,
			safeY 		= 75,
		},
	...
	[4] = { 
			...
			level 		= nil,
			mapType 	= MapType.City,
			npcs 		= {29060,20005,20025,29044,29067,29051,29073, },
			safeX 		= 133,
			safeY 		= 62,
		},
	...
	[5] = { 
			...
			level 		= nil,
			mapType 	= MapType.City,
			npcs 		= {29042,20024,20009,29055,29077,29071,29064, },
			safeX 		= 119,
			safeY 		= 64,
		},
	...
	[6] = { 
			...
			level 		= nil,
			mapType 	= MapType.City,
			npcs 		= {29043,20026,29076,20008,29063,29054,29070, },
			safeX 		= 102,
			safeY 		= 63,
		},
	...
	[10] = { 
			...
			level 		= 0,
			mapType 	= MapType.City,
			npcs 		= {20059,30320,20049,29008,29048,29006,30250,20018,20913,60000,27150,29079,29046,20928,29065,20012,20013,20014,20015,20016,29001,29002,29003,20106,20107,20108,29004,20017,39000,29056,29005,29007,20060, },
			safeX 		= 189,
			safeY 		= 208,
