...
defineAttr("pet_add_win_at", "风攻击+", false, false)
defineAttr("pet_add_thu_at", "雷攻击+", false, false)
defineAttr("pet_add_ice_at", "冰攻击+", false, false)
defineAttr("pet_add_soi_at", "土攻击+", false, false)
defineAttr("pet_add_fir_at", "火攻击+", false, false)
defineAttr("pet_add_poi_at", "毒攻击+", false, false)	 
...
defineAttr("pet_add_win_resist", "风抗+", false, false)
defineAttr("pet_add_thu_resist", "雷抗+", false, false)
defineAttr("pet_add_ice_resist", "冰抗+", false, false)
defineAttr("pet_add_soi_resist", "土抗+", false, false)
defineAttr("pet_add_fir_resist", "火抗+", false, false)
defineAttr("pet_add_poi_resist", "毒抗+", false, false)
...
defineAttr("pet_df_grow", "物防成长", false, true)
...
defineAttr("pet_df_grow_max", "物防成长最大值", false, true)
...
defineAttr("pet_add_obstacle_hit", "障碍命中+", false, false)
defineAttr("pet_taunt_resist", "抗嘲讽", true, false)
defineAttr("pet_add_taunt_resist", "抗嘲讽+", false, false)
defineAttr("pet_inc_taunt_resist", "抗嘲讽", false, false)
defineAttr("pet_sopor_resist", "抗昏睡", true, false)
defineAttr("pet_add_sopor_resist", "抗昏睡+", false, false)
defineAttr("pet_inc_sopor_resist", "抗昏睡", false, false)
defineAttr("pet_chaos_resist", "抗混乱", true, false)
defineAttr("pet_add_chaos_resist", "抗混乱+", false, false)
defineAttr("pet_inc_chaos_resist", "抗混乱", false, false)
defineAttr("pet_freeze_resist", "抗冰冻", true, false)
defineAttr("pet_add_freeze_resist", "抗冰冻+", false, false)
defineAttr("pet_inc_freeze_resist", "抗冰冻", false, false)
defineAttr("pet_silent_resist", "抗沉默", true, false)
defineAttr("pet_add_silent_resist", "抗沉默+", false, false)
defineAttr("pet_inc_silent_resist", "抗沉默", false, false)
defineAttr("pet_toxicosis_resist", "抗中毒", true, false)
defineAttr("pet_add_toxicosis_resist", "抗中毒+", false, false)
defineAttr("pet_inc_toxicosis_resist", "抗中毒", false, false)
